            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="/coffee?action=create">Add Products</a></li>
                        <li>
                            <hr class="dropdown-divider"/>
                        </li>
                        <li><a class="dropdown-item" href="#!">Popular Items</a></li>
                        <li><a class="dropdown-item" href="/orders">New Arrivals</a></li>
                    </ul>
                </li>
            </ul>
            <form class="d-flex">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="badge text-white position-absolute"
                            ...
                            <button class="btn btn-outline-dark btn-sm"
                                   >
                                <a  href="/coffee?action=remove&id=${product.product_id}">delete</a>
                            </button>
                        </div>
                        <!-- Product image-->
                        <img
